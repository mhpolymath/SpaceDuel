...
#start button image
ORIGINAL_START_BUTTON = pygame.image.load(os.path.join("Assets", "start.png"))
...
#exit button image
ORIGINAL_EXIT_BUTTON = pygame.image.load(os.path.join("Assets", "quit.png"))
ORIGINAL_EXIT_BUTTON_WIDTH, ORIGINAL_EXIT_BUTTON_HEIGHT = ORIGINAL_EXIT_BUTTON.get_width(), ORIGINAL_EXIT_BUTTON.get_height()
#reset button image
ORIGINAL_RESET_BUTTON = pygame.image.load(os.path.join("Assets", "reset.png"))
ORIGINAL_RESET_BUTTON_WIDTH, ORIGINAL_RESET_BUTTON_HEIGHT = ORIGINAL_RESET_BUTTON.get_width(), ORIGINAL_RESET_BUTTON.get_height()
...
START_BUTTON_FINAL_IMAGE = SCALED_START_BUTTON_IMAGE
START_BUTTON_FINAL_WIDTH, START_BUTTON_FINAL_HEIGHT = SCALED_START_BUTTON_WIDTH, SCALED_START_BUTTON_HEIGHT
EXIT_BUTTON_FINAL_IMAGE = SCALED_EXIT_BUTTON_IMAGE
EXIT_BUTTON_FINAL_WIDTH, EXIT_BUTTON_FINAL_HEIGHT = SCALED_EXIT_BUTTON_WIDTH, SCALED_EXIT_BUTTON_HEIGHT
RESET_BUTTON_FINAL_IMAGE = SCALED_RESET_BUTTON_IMAGE
RESET_BUTTON_FINAL_WIDTH, RESET_BUTTON_FINAL_HEIGHT = SCALED_RESET_BUTTON_WIDTH, SCALED_RESET_BUTTON_HEIGHT