...
ORIGINAL_BACKGROUND_IMAGE = pygame.image.load(os.path.join("Assets", "space.png"))
...
SCALED_BACKGROUND_IMAGE = pygame.transform.scale(ORIGINAL_BACKGROUND_IMAGE, (W_WIDTH, W_HEIGHT))
...
BACKGROUND_FINAL_IMAGE = SCALED_BACKGROUND_IMAGE
